    ...
    fNewRecipientAllowed(true)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Alancoin address (e.g. MURTDp3LdR98Cufh9BbSSqUPJFEtPKSLSe)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Alancoin address"));
        }
        else // Valid address
        {
            CPubKey pubkey;
